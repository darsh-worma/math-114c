...
\maketitle
\begin{abstract}
    Hello and welcome! As the title suggests, these are my lecture notes on Game Theory. Our professor is \textbf{Tyler Arant}. The textbook that we are using is \textbf{Computability by NJ Cutland}.
